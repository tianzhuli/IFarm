...
public class ByteConvert {
	/**
	 * 按照约定将对应的collectorDeviceId转成字节
	 * 
	 * @param controlDeviceId
	 * @return
	 */
	public static byte[] convertTobyte(String controlDeviceId) {
	...
	public static byte[] terminalBitsConvert(int[] bits) {
		byte[] arr = new byte[4];
		for (int i = 0; i < 4; i++) {
			int sum = 0;
			for (int j = 0; j < 8; j++) {
	...
	public static void main(String[] arg0) {
		byte[] arr = convertTobyte("70700010");
